!INPUT:  a1, b1 (a1>b1): length of semiaxis of first ellipse
    ...
    program Distanceellipses
        IMPLICIT NONE
        Double Precision::a1,b1,a2,b2,theta1,theta2,theta3,xc1,yc1
        Double Precision::dist,xt,yt
        OPEN(UNIT=100,FILE='entradaprueba.txt',STATUS='unknown')
        READ(100,*)  a1 
        READ(100,*)  b1
        READ(100,*)  a2
        READ(100,*)  b2
        ...
        CALL ELLIPSES(a1,b1,a2,b2,theta1,theta2,theta3,xc1,yc1,dist,xt,yt)

        WRITE(*,*) "distancia ", dist
        WRITE(*,*) "valores de los puntos de contacto: ", xt,",", yt
        STOP
    end program 
